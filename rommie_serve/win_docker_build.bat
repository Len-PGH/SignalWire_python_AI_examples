...
echo.
echo ============================================
echo Building Docker image 'roomie_serve_image'...
echo ============================================
docker build -t "roomie_serve_image" .
if %ERRORLEVEL% NEQ 0 (
    echo.
...
echo ============================================
set /p containerName=Enter name for the new container (default: roomie_serve_container): 

if "%containerName%"=="" set "containerName=roomie_serve_container"
...
docker run -it --name "%containerName%" "roomie_serve_image" bash
